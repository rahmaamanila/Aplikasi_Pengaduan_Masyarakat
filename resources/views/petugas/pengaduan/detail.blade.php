                    ...
                    <div class="col-md-8">
                        <div class="card mt-2">
                            <div class="card-header">
                                <a href="/petugas/pengaduan" class="btn btn-outline-primary"><i class='bx bxs-left-arrow-circle'></i> Kembali</a>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <tbody>
                                ...
                                <br>
                                <div class="d-flex">
                                    <form action="{{ route('petugas.statusOnchange', $pengaduan->id_pengaduan)}}" method="post">
                                    @csrf
                                        ...
                                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="/petugas/pengaduan/detail/{id}">
                                                    {{ csrf_field() }}
                                                ...
                                                <div class="modal fade" id="modal" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" action="/petugas/pengaduan/update/{{$pengaduan->id_pengaduan}}">
                                                            {{ csrf_field() }}
                                                            {{ method_field('PUT') }}
