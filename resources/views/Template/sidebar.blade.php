<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="#" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-6">Pengkat</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="/masyarakat/create" class="menu-link">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Tables">Buat Pengaduan</div>
      </a>
    </li>
    @endif
    ...
    @if (auth()->user()->level == "masyarakat")
    <li class="menu-item">
      <a href="/masyarakat/laporanku" class="menu-link">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Tables">Laporanku</div>
      </a>
    </li>
    @endif
    ...
    <li class="menu-item">
      <a href="/tanggapan" class="menu-link">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Tables">Tanggapan</div>
      </a>
    </li>
    @endif -->
    ...
    <!-- @if (auth()->user()->level == "petugas")
    <li class="menu-item">
      <a href="/petugas/tanggapan" class="menu-link">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Tables">Tanggapan</div>
      </a>
    </li>
